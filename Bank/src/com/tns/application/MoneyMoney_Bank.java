...
//		Previous Objects
		MMCurrentAcc cAcc = new MMCurrentAcc(101, "Vikas", accBal, creditLimit);
		MMSavingAcc sAcc = new MMSavingAcc(105, "Avantika", accBal, true);
...
//				CURRENT ACCOUNT Object Creation
				...
				case 1:
					...
					System.out.println("CREDIT LIMIT: " + "Avantika");
					break;
				case 2:
					System.out.println("Enter Ammount:");
					amt = sc.nextFloat();
